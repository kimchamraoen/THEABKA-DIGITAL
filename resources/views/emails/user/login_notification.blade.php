        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background-color:#161b22;border:1px solid #30363d;border-radius:12px;box-shadow:0 18px 48px rgba(0,0,0,0.45);overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:6px 24px 0 24px;font-size:24px;line-height:30px;font-weight:700;color:#ffffff;">A new login was detected on your account</td>
                    </tr>
                    <tr>
                        <td style="padding:8px 24px 0 24px;font-size:15px;line-height:24px;color:#9da7b3;">Hi {{ $payload['name'] ?? 'there' }}, we noticed a successful login to your account.</td>
                    </tr>
                    <tr>
                        <td style="padding:18px 24px 0 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#0f141b;border:1px solid #30363d;border-radius:10px;padding:14px;">
                                <tr><td style="padding:6px 10px 6px 12px;border-left:3px solid #3b82f6;font-size:15px;line-height:24px;color:#d0d7de;"><strong style="color:#ffffff;">🕐 Login Time:</strong> {{ $payload['login_time'] ?? '' }}</td></tr>
                                ...
                                <tr><td style="padding:6px 10px 6px 12px;border-left:3px solid #3b82f6;font-size:15px;line-height:24px;color:#d0d7de;"><strong style="color:#ffffff;">💻 Device:</strong> {{ $payload['device_type'] ?? 'Unknown' }}</td></tr>
                    ...
                    <tr>
                        <td style="padding:20px 24px 0 24px;font-size:15px;line-height:24px;color:#fca5a5;">If this wasn't you, please change your password immediately.</td>
                    </tr>
                    <tr>
                        <td style="padding:20px 24px 0 24px;">
                            <a href="{{ $payload['profile_url'] ?? url('/user/profile') }}" style="display:inline-block;padding:12px 20px;background-color:#2563eb;border-radius:8px;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;">Review Security Settings</a>
                        </td>
                    </tr>
                    <tr>
